...
const AboutUs = () => {
    const reasons = [
        ...
        },
        {
            ...
            desc: 'Provides 24/7 online service and daily updates on orders.Quality Assurance: Implements strict quality control measures with five stages of testing for each product.',
    ...
    return (
        <div className="bg-white text-gray-800 font-inter">
            ...
            <section className="bg-white text-center py-20 px-6 shadow-inner">
                ...
                {/* <h1 className="text-4xl font-bold text-navy-blue mb-2">About Us</h1> */}
                <p className="max-w-2xl mx-auto text-gray-600 text-lg">
                    {/* Hikotek is committed to building the future of secure, smart, and connected environments. */}
                </p>
            </section>
